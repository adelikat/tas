...
--The foes have a treasure chest
...
local function _lv2()
    ...
    c.RndAorB() -- The foes have a treasure chest
    c.RandomFor(1)
    c.WaitFor(35)
    ...
    c.DelayUpTo(c.maxDelay)
    c.RndAorB() -- Finds the wing of wyvern
    c.RandomFor(1)
    c.WaitFor(247)
    c.UntilNextInputFrame()
    ...
    c.Save('Lv2-VitSkip-Rng2-' .. c.ReadRng2() .. '-Rng1-' .. c.ReadRng1() .. '-' .. emu.framecount())
