-- Starts at the first frame to dismiss "terrific blow" from the Radimvice Fight
-- Str 4
-- Ag 2
-- Vit any
-- Int any
...
local function _luckSkip()
    ...
    if c.ReadRng2() == 89 and c.ReadRng1() == 110 then
        return c.Bail('Already got this one and it was bad')
    end
